...
Tutorial parts:
  ...
  4. [Mapbox set up](./4_uploading_mbtiles_to_mapbox): MapBox will host our tiles and serve them whenever we need them. In this step, we will set up a MapBox account and upload our tiles.
